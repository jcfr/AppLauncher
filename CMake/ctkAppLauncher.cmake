...
set(${v} \"${${v}}\")")
  ...
  string(REPLACE ";" "," CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS
    "${CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS_BUILD}")
  set(CMAKE_CONFIGURABLE_FILE_CONTENT
...
message(STATUS "\n\nextra build path envvars: ${CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS_BUILD}\n")

  foreach(envvar ${CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS_BUILD})
    set(cmake_varname ${CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS_PREFIX}${envvar}_BUILD)
message(STATUS "\n\nextra build path envvar '${envvar}' (${cmake_varname}): ${${cmake_varname}}\n\n")
...
set(CTKAPPLAUNCHER_ADDITIONAL_PATHS \"${CTKAPPLAUNCHER_ADDITIONAL_PATHS}\")")
  ...
  string(REPLACE ";" "," CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS
    "${CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS_INSTALLED}")
  set(CMAKE_CONFIGURABLE_FILE_CONTENT
"set(CTKAPPLAUNCHER_APPLICATION_SUBDIR \"${CTKAPPLAUNCHER_APPLICATION_SUBDIR}\")
set(CTKAPPLAUNCHER_SPLASH_IMAGE_SUBDIR \"${CTKAPPLAUNCHER_SPLASH_IMAGE_SUBDIR}\")
set(CTKAPPLAUNCHER_EXTRA_APPLICATION_TO_LAUNCH \"${CTKAPPLAUNCHER_EXTRA_APPLICATION_TO_LAUNCH}\")
...
set(CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS \"${CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS}\")")
  ...
  foreach(envvar ${CTKAPPLAUNCHER_ADDITIONAL_PATH_ENVVARS_INSTALLED})
    ctkAppLauncherListToQtSettingsArray("${${ADDITIONAL_PATH_ENVVARS_PREFIX}${envvar}_INSTALLED}" "path" CTKAPPLAUNCHER_ADDITIONAL_PATHS_${envvar})
    set(CTKAPPLAUNCHER_ADDITIONAL_PATHS "${CTKAPPLAUNCHER_ADDITIONAL_PATHS}
${CTKAPPLAUNCHER_ADDITIONAL_PATHS_${envvar}}")
  endforeach()
